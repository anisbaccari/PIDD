  ...
  <div class="cart-page">
    ...
    <nav class="navigation">
      ...
      <div class="nav-links">
        ...
        <router-link to="/cart" class="nav-link">Panier ({{ totalItems }})</router-link>
      </div>
      <div class="nav-login">
            ...
            <div class="cart-items">
              ...
              >
                ...
                <div class="item-details">
                  ...
                  <p class="product-price-unit">{{ formatPrice(item.price) }}</p>
                </div>
          ...
          <div class="order-summary">
            <div class="summary-card">
              ...
              <div class="summary-line">
                ...
                <span>{{ deliveryPrice === 0 ? 'Gratuit' : formatPrice(deliveryPrice) }}</span>
              </div>
...
export default {
  ...
  methods: {
    // 🎯 US8: Afficher le contenu du panier
    async loadCart() {
      try {
    ...
    // 🎯 US9: Modifier la quantité d'un produit
    async updateQuantity(productId, newQuantity) {
      try {
        ...
        // Simulation d'appel API - À remplacer par PUT /cart/:id
        console.log(`🔄 Mise à jour quantité: produit ${productId} -> ${newQuantity}`);
    ...
    // 🎯 US9: Supprimer un produit du panier
    async removeItem(productId) {
      try {
        // Simulation d'appel API - À remplacer par DELETE /cart/:id
    ...
    // 🎯 US9: Ajouter un produit au panier (méthode réutilisable)
    ...
    // Méthode utilitaire pour sauvegarder dans localStorage
    saveCartToLocalStorage() {
      localStorage.setItem('monShop_cart', JSON.stringify(this.cartItems));
    },
    
    // 🎯 US10: Procéder au paiement (préparation)
    proceedToCheckout() {
